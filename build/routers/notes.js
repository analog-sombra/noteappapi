...
noteRouter.get("/note/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
noteRouter.patch("/note", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let response = { status: false, data: [], message: "Something went wrong try again!", function: "getNoteCount" };
    const result = yield (0, notes_1.getNoteCount)();
    response = result;
    res.send(response);
    res.end();
}));
noteRouter.delete("/note/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let response = { status: false, data: [], message: "Something went wrong try again!", function: "deleteNote" };
    const id = req.params.id;
    const result = yield (0, notes_1.deleteNote)(id);
    response = result;
    res.send(response);
    res.end();
}));
...
noteRouter.put("/note/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let response = { status: false, data: [], message: "Something went wrong try again!", function: "deleteAllNotes1" };
    const id = req.params.id;
    const result = yield (0, notes_1.upadteNote)(id);
    response = result;
    res.send(response);
    res.end();
}));
